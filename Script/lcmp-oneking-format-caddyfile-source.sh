...
#改配置文件路径：“/home/caddy/etc/Caddyfile”改为“/etc/caddy/Caddyfile”
#修改软件下载地址：http://source.loshub.com，（解决源下载慢的问题“服务器在亚马逊云香港”）
clear
echo '================================================================'
...
function InstallLibassembly() {
	...
	cd 	libiconv-1.17
	./configure --prefix=/usr/local/libiconv && make -j$Cpunum && make install
	cd .. && rm -rf libiconv-1.17 libiconv-1.17.tar.gz
