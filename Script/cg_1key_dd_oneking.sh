...
EOF
  ...
  sed -i '/^ZSH_THEME=/c\ZSH_THEME="agnoster"' ~/.zshrc #设置主题“jtriley”或者“agnoster”
...
EOF
  ...
  #bash <(curl -Ls https://raw.githubusercontent.com/FranzKafkaYu/x-ui/master/install.sh)   #tg消息版
  #别名设置
  set_alias
  #预装ohmyzsh和ohmytmux
  check_beautify
